...
namespace RatUI
{
    struct BumpAllocator
    {
		...
		BumpAllocator( u8* a_Buffer, u32 a_Capacity )
        ...
        void* Allocate( u32 a_Size, u32 a_Alignment = 1 )
        {
        ...
        T* Allocate( u32 a_Count = 1 )
        {
			return static_cast<T*>( Allocate( sizeof( T ) * a_Count, alignof( T ) ) );
        }
